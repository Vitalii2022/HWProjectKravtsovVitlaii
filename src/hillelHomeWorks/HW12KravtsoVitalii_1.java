...
public class HW12KravtsoVitalii_1 {
...
class Box1 {
    ...
    public Box1(double newWidth, double newHeight, double newLength) {
        width = newWidth;
        height = newHeight;
        length = newLength;
    }

    public Box1(double newWidth, double newHeight, double newLength, Material newMaterial) {
        this(newWidth, newHeight, newLength);
